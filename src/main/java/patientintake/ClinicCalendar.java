...
//   }
   ...
   public List<PatientAppointment> getAppointments(LocalDate of) {
   ...
   /* It take a local date, representing a day, and should respond true if there are any appointments scheduled on that day */
